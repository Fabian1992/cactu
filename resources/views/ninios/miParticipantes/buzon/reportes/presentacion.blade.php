<div class="contenedor">
    ...
    <div class="cuerpo">
        ...
        <p>y mis amigos me dicen {{$buzonCarta->respuesta?$res[4]:''}} .Tengo  años {{$buzonCarta->respuesta?$res[5]:''}} </p></p>
        <p>Mi mejor amigo se llama {{$buzonCarta->respuesta?$res[6]:''}} </p></p>
        <p>y es mi mejor amigo porque {{$buzonCarta->respuesta?$res[7]:''}} </p></p>
        ...
        <table width="100%">
            <thead>
             ...
             <tbody>
                 <tr>                  
                     <td>
                         <p>Lo que más me gusta hacer es {{$buzonCarta->respuesta?$res[8]:''}} </p></p>
                    </td>
                     <td  rowspan="3">
                         <div class="medidaIma"> 
    ...
    <div class="cuerpo2">
        <p>
           Lo que me gustaría aprender en el programa de ChildFund es <br> {{$buzonCarta->respuesta?$res[13]:''}} 
        </p>
    </div>
    <br>
    <br>
...
<div class="contenedor2">
    ...
    <p>Donde nostros vivomos hay un sitios muy hermosas</p>
        <p>mi lugar favorito es {{$buzonCarta->respuesta?$res[17]:''}}</p>
    </div>
    <div class="cuerpo3">
        <p>También tenemos cominda típia, por ejemplo <br>
    ...
    <div class="cuerpo4">
    <p><span style="color: rgb(245, 12, 12)">Me gustaía hacerte una pregunta...</span></p>
...
<style>
    ...
    .contenedor2{
        background-image: url("{!! public_path('/buzon/img/piepremayores.jpg') !!}");
        background-repeat: no-repeat;
        background-size: 100% 1350px; 
        width: 100%;
        height: 1290px;
