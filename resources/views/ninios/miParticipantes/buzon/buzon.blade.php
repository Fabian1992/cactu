    ...
    <div class="timeline timeline-center ">
        <div class="timeline-container ">
            ...
            <div class="text-center ">
                ...
                --}}
                <a class="btn btn-primary timeline-content btn-ladda btn-ladda-progress ladda-button" href="{{ route('crearBuzonParticipante',$ninio->id) }}" type="button">
                    <i class="icon-plus3 ">
                    </i>
                    <span>
                        Nuevo
                ...
                <button class="btn bg-info timeline-content btn-ladda btn-ladda-progress ladda-button" data-idni="{{$ninio->id}}" onclick="verMensajes(this)" type="button">
                                        ...
                                        <ul class="media-list">
                                            <li class="media">
                                                ...
                                                <div class="media-body text-center">
                                                    <div>
                                                        <button class="btn bg-blue-800 timeline-content btn-ladda btn-ladda-progress ladda-button" data-nombrecrata="{{$buzonCarta->nombre}}" data-url="{{ route('vistaCartaPdf',Crypt::encryptString($buzonCarta->cartasBuzon->id)) }}" onclick="abrirModalCarta(this);">
    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content contenedor border-top-info ">
            ...
            <div class="text-right mt-1 mr-4">
                <button class="btn btn-default text-danger border borde-danger rounded-round" data-dismiss="modal" type="button">
      ...
      .done(function(d) {
          if (d.noex == "noexi") {
            ...
            $.each(d.mensajes, function(i, item) {
                var nn =  '<li class="media content-divider justify-content-center text-muted mx-0">'+d.mensajes[i].fecha+'</li>'+''+              
                          '<li class="media">'+''+
                            '<div class="mr-3">'+''+
                              '<a href="#">'+''+
